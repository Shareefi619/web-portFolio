  ...
  return (
    <motion.div
      className="flex items-center justify-center rounded-full bg-dark font-semibold text-light
       px-6 py-3 shadow-dark cursor-pointer absolute dark:bg-light dark:text-dark
       ...
       ">
        <motion.div
          className="flex items-center justify-center rounded-full bg-dark font-semibold
           text-light p-6 shadow-dark cursor-pointer  dark:bg-light dark:text-dark lg:p-6 md:p-4 xs:text-xs xs:p-2"
          whileHover={{ scale: 1.05 }}
        >
          WEB
        </motion.div>
